...
use crate::utils::fonts::{FontCacheInfo, FontInfo, get_font_manager};
use tauri::AppHandle;

/// Get available UI fonts (sans-serif fonts)
///
/// Returns a list of sans-serif fonts suitable for UI elements.
/// The fonts are cached for performance and refreshed automatically every 24 hours.
#[tauri::command]
...
///
/// Forces a rebuild of the font cache by scanning system fonts.
/// This can be called when new fonts are installed on the system.
#[tauri::command]
