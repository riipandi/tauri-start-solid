...
modern web development best practices. Under the hood, it uses Tailwind CSS, Kobalte, Corvu, and
TypeScript to deliver accessible, type-safe, and customizable components. The design is based
on shadcn/ui.

## Key Features

- 🎨 Modern styling with Tailwind CSS and Tailwind Variants
- ♿️ Accessible components with Kobalte and Corvu
